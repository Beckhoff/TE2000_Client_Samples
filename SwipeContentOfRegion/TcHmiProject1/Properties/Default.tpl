  ...
  <script>
		...
		TCHMI_CONFIG_OVERRIDE = {
   	    ...
   	    window.onload = function load() {
			if((!TcHmi || !TcHmi.System || !TcHmi.System.Init) && document.body){
				document.body.innerHTML = 'TwinCAT HMI Framework could not be loaded. Perhas a more modern web browser (which supports ES6 JavaScript) is needed.';
			}
		};
  </script>
  {{GLOBAL_JS_INCLUDES}}
